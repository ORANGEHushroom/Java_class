...
public class GuGuDanTest {
	...
	public static void main(String[] args) {
		 ...
		 * 4. 반복문(본인이 편한 반복문사용)을 활용하여 짝수 구구단만 출력 2 4 6 8단
		 * 5. 반복문(본인이 편한 반복문사용)을 활용하여 홀수스텝의 구구단만 출력 2*1=2 2*3=6,,,
		 * 
		 *  
		 *  출력형식 :
	      1. for 구문을 활용한 구구단
		...
		System.out.println();
		System.out.println("4. 반복문(본인이 편한 반복문사용)을 활용하여 짝수 구구단만 출력 2 4 6 8단");
